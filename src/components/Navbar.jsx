                ...
                <div>
                    {
                        ...
                        {
                            isDropdownOpen &&(
                                <div className="absolute right-0 mt-0 w-48 bg-white shadow-lg rounded-md z-40">
                                    <ul className="py-2">
                                        {
                                            navigation.map((item)=>(
                                        ...
                                        <li>
                                            <button
                                            onClick={handleLogOut} className="block w-full text-left px-4 py-2 text-sm hover:bg-gray-100">Logout</button>
                                        </li>
                                    </ul>
                                </div>
                            )
